import img1 from './../../assests/img/ngekos_logo - Copy.png'

function componen_about() {
    return (
        <section id="about" class="d-flex align-items-center">
              <div class="container">
                ...
                <div class="text-center p-5 col-lg-6 desc" data-aos="fade-left" data-aos-delay="200">
                <img
